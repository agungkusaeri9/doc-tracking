            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <h6 class="mb-3">TTE SPD</h6>
                            <li class="list-item mb-2">
                                <b>Pembuat TTE</b>
                                <br>
                                <span>{{ $item->tte_spd_created_user->name ?? '-' }}</span>
                            </li>
                            <li class="list-item mb-2">
                                <b>Tanggal TTE</b>
                                <br>
                                <span>{{ $item->tte_spd_created->translatedFormat('H:i:s d-m-Y') ?? '-' }}</span>
                            </li>
                            <li class="list-item mb-2">
                    ...
                    @if ($item->tte_spd_created == null)
                        <form
                            action="{{ route('documents.tte.spd.create', [
                                'uuid' => $item->uuid,
                            ]) }}"
                            method="post">
                            @csrf
